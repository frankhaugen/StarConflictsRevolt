...
This project contains shared components used by all client implementations (Blazor and future clients) to avoid code duplication and ensure consistency.
...
**Project path:** `StarConflictsRevolt.Clients.Shared/`
