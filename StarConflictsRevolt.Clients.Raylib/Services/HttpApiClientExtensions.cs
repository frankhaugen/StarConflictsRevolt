...
public static class HttpApiClientExtensions
{
    ...
    public static async Task<LeaderboardDto?> GetLeaderboardAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await client.GetAsync<LeaderboardDto>($"/leaderboard/{sessionId}", cancellationToken);
    }
    ...
    public static async Task<PlayerStatsDto?> GetPlayerStatsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await client.GetAsync<PlayerStatsDto>($"/leaderboard/{sessionId}/player/{playerId}", cancellationToken);
    }
