...
public interface IGamePersistence
{
    ...
    Task<List<Session>> GetActiveSessionsByPlayerAsync(string playerId, CancellationToken cancellationToken = default);
    Task<List<Session>> ListActiveSessionsAsync(CancellationToken cancellationToken = default);
